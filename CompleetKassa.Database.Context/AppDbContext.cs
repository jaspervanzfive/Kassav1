using System.Linq;
using CompleetKassa.Database.CompleetKassa.Database.Context.Extensions;
using Microsoft.EntityFrameworkCore;

namespace CompleetKassa.Database.Context
{
    public class AppDbContext : DbContext
	{
		...
		protected override void OnModelCreating (ModelBuilder modelBuilder)
		{
			...
			//Get (Data Configurations) from referenced assembly, Database.Core.EF
